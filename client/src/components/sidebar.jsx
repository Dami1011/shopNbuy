...
export default function Sidebar() {
  ...
  const { currentUser, logoutUser, links, adminLinks } = useStore();
        ...
        <Offcanvas.Body>
                ...
                {data.map((category) => (
                  <div key={category._id} className="mb-3">
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        isActive
                          ? "text-success fs-3 fw-bold fs-5"
                          : "text-black fs-3 fw-medium"
                      }
                      onClick={handleClose}
                    >
                      {category.name}
          ...
          {currentUser && (
            <>
              ...
              <hr />
              <div className="d-flex align-items-center" onClick={logoutUser}>
