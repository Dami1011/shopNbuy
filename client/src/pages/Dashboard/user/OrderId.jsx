        ...
        <Row>
          ...
          <Col md={3} className="mb-3">
            ...
            <div className="mb-2">
              ...
              {data.isDelivered ? (
              <p>Delivered {data.delieveredAt}</p>
              ) : (
                 <p>{isPay}</p>
                )}
            </div>
          ...
          <p className="fs-6 fw-bold">Total: {formatCurrency(data.totalPrice)}</p>
          </>
          </Col>
          <Col md={6} className="mb-3">
            <>
          ...
          <p className="fs-6">Mode: {data.shippingDetails?.address}</p>
          <p className="fs-6 mb-1">Receiver: {data.shippingDetails?.fullname}</p>
          <p className="fs-6 mb-1">Phone: {data.shippingDetails?.phone}</p>
          <p className="fs-6 mb-1">Location: {data.shippingDetails?.state}</p>
